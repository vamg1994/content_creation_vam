            ...
            "messages": [
                {
                    ...
                    "content": (
                        "Follow these guidelines:"
                        f"Use this language:{language_instruction} "
                        ...
                        "Use recent news and events for reference when creating the ideas, hook and CTA for adding more context. Provide a brief explanation of why it's relevant and links to the source with complete url"
